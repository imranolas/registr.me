...
describe KlassesController do
  ...
  let(:valid_attributes) { { "name" => "MyString", attendance: 75 } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved klass as @klass" do
        ...
        post :create, {:klass => { "name" => "invalid value" }}, valid_session
        assigns(:klass).should be_a_new(Klass)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested klass" do
        ...
        Klass.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => klass.to_param, :klass => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the klass as @klass" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Klass.any_instance.stub(:save).and_return(false)
        put :update, {:id => klass.to_param, :klass => { "name" => "invalid value" }}, valid_session
        assigns(:klass).should eq(klass)
      end
